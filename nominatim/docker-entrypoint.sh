...
# Defaults
NOMINATIM_DATA_PATH=${NOMINATIM_DATA_PATH:="/home/nominatim/data"}
...
curl https://osm-nominatim.s3-ap-southeast-1.amazonaws.com/vn/nominatim_data.tgz_aa -o $NOMINATIM_DATA_PATH
